...
class ProductsController extends Controller
{
    ...
    public function todosProdutosAdmin(){
        ...
        ->addColumn('action', function ($model) {
            return "<button class='btn btn-success editar_botao' id='" . $model->id . "' style='margin-right:3px;'><span class='fa fa-edit'></span></button><button data-toggle='confirm_delete_produto' id='" . $model->id ."' class='btn btn-danger excluir_botao'><span class='fa fa-trash-o'></span></button>";
        })
        ->toJson();
    }
